...
be percent-encoded if they occur in the name of a synonym list or in synonyms themselves.
Solarium handles this for you. However, if you're still using a Solr version that's
